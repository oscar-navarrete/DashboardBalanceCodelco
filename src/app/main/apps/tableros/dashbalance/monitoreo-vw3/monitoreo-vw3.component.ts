...
@Component({
  selector: 'app-monitoreo-vw3',
  templateUrl: './monitoreo-vw3.component.html',
  styleUrls: ['./monitoreo-vw3.component.scss']
})
export class MonitoreoVW3Component implements OnInit {
