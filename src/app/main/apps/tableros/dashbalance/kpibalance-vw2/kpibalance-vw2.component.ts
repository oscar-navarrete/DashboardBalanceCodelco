...
@Component({
  selector: 'app-kpibalance-vw2',
  templateUrl: './kpibalance-vw2.component.html',
  styleUrls: ['./kpibalance-vw2.component.scss']
})
export class KpibalanceVW2Component implements OnInit {
  fecha: any;
  fechakpi: any;
  config: any = {};
  updateFlag = false;
  ...
  graficoAjusteInventario(data: any, limite: number): void {
    ...
    setTimeout(() => {
      this.ajusteinventario = this.objects.getSimpleColumnChartVW(info, '1500', '350');
      this.updateFlag = true;
    }, 2000);
  }
  ...
  graficoSobreajuste(data: any, limite: number): void {
    ...
    setTimeout(() => {
      this.sobreajuste = this.objects.getSimpleColumnChartVW(info, '1500', '600');
      this.updateFlag = true;
    }, 2000);
  }
  ...
  graficoNroEjecuciones(data: any, limite: number): void {
    ...
    setTimeout(() => {
      this.nroejecuciones = this.objects.getSimpleColumnChartVW(info, '1500', '600');
      this.updateFlag = true;
    }, 2000);
  }
  ...
  graficoIncertidumbreDatosBases(data: any, limite: number): void {
    ...
    setTimeout(() => {
      this.incertidumbre = this.objects.getSimpleColumnChartVW(info, '1500', '350');
      this.updateFlag = true;
    }, 2000);
  }
  ...
  graficoDesbalanceGlobal(data: any, limite: number): void {
    ...
    setTimeout(() => {
      this.desbalanceglobal = this.objects.getSimpleColumnChartVW(info, '1500', '350');
      this.updateFlag = true;
    }, 2000);
  }
  ...
  graficoDesbalancePorNodoCu(data: any, limite: number): void {
    ...
    setTimeout(() => {
      this.desbalancePorNodo = this.objects.getSimpleColumnChartVW(info, '1500', '350');
      this.updateFlag = true;
    }, 2000);
  }
