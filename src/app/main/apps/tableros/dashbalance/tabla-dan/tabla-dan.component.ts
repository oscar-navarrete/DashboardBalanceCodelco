...
@Component({
  selector: 'app-tabla-dan',
  templateUrl: './tabla-dan.component.html',
  styleUrls: ['./tabla-dan.component.scss']
})
export class TablaDANComponent implements OnInit {
  ...
  generaTablas() {
    this.getDataConcentradora('tabladanconcentradora');
    this.getFechaPortal();
  }
