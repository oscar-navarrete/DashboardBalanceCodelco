...
@Component({
  selector: 'app-monitoreo-vw',
  templateUrl: './monitoreo-vw.component.html',
  styleUrls: ['./monitoreo-vw.component.scss']
})
export class MonitoreoVwComponent implements OnInit {
