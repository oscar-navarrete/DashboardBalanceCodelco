...
@Component({
  selector: 'app-kpibalance-vw',
  templateUrl: './kpibalance-vw.component.html',
  styleUrls: ['./kpibalance-vw.component.scss']
})
export class KpibalanceVWComponent implements OnInit {
